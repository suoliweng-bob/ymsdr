...
SpectrumSinkFileThread::SpectrumSinkFileThread() : SpectrumSinkThread() {

}

SpectrumSinkFileThread::~SpectrumSinkFileThread() {
    if (audioFileHandler != nullptr) {
        audioFileHandler->closeFile();
    }
}

void SpectrumSinkFileThread::sink(SpectrumVisualDataPtr input) {
    if (!audioFileHandler) {
        return;
    }
...
void SpectrumSinkFileThread::inputChanged(SpectrumVisualData /* oldProps */, SpectrumVisualDataPtr /* newProps */) {
    // close, set new parameters, adjust file name sequence and re-open?
    if (!audioFileHandler) {
        return;
    }
	...
	setSectrumFileHandler(audioFileHandler);

	//reset duration counter
	durationMeasurement.start();
}

void SpectrumSinkFileThread::setSectrumFileNameBase(const std::string& baseName) {

	fileNameBase = baseName;
}

void SpectrumSinkFileThread::setSectrumFileHandler(SpectrumFile * output) {
    audioFileHandler = output;
...
// Time limit
void SpectrumSinkFileThread::setFileTimeLimit(int nbSeconds) {
